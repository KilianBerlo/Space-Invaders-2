...
public class EnemyShader extends ShaderProgram {
	...
	private static final String VERTEX_FILE = "/enemy/enemyVertexShader.txt";
	private static final String FRAGMENT_FILE = "/enemy/enemyFragmentShader.txt";
	...
	private int location_morphingPhase;
	private int location_dmgDiscolor;
	...
	protected void getAllUniformLocations() {
		...
		location_morphingPhase = super.getUniformLocation("morphingPhase");
		location_dmgDiscolor = super.getUniformLocation("dmgDiscolor");
	}
	...
	public void loadMorphingPhase(float phase) {
		super.loadFloat(location_morphingPhase, phase);
	}
	...
	public void loadDmgDiscolor(boolean doDiscolor) {
		this.loadBoolean(location_dmgDiscolor, doDiscolor);
	}
