...
public class VoxelWorldShader extends ShaderProgram {
	private static final int MAX_LIGHTS= 4;
	
	private static final String VERTEX_FILE = "/voxelWorld/voxelWorldVertexShader.txt";
	private static final String FRAGMENT_FILE = "/voxelWorld/voxelWorldFragmentShader.txt";
	...
	protected void bindAttributes() {
		...
		super.bindAttribute(3, "materialAttrib");
	...
	public void loadLights(Light sun, ArrayList<BlockLight> arrayList, Matrix4f viewMatrix) {
		super.loadVector(location_sunLight, getEyeSpacePosition(sun, viewMatrix));
		
		for(int i = 0; i < MAX_LIGHTS; i++) {
			if(i < arrayList.size()) {
				super.loadVector(location_lightPosition[i], getEyeSpacePosition(arrayList.get(i), viewMatrix));
